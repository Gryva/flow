...
const translations = {
  en: {
    ...
    cancel: 'Cancel',
    save: 'Save',
    aboutText: 'TOK is a DJ prompter for YouTube Music playlists — it listens to the current song and suggests the next one by tempo, energy and key, so the mix flows smoothly without interruptions.',
    close: 'Close',
  ...
  hr: {
    ...
    cancel: 'Odustani',
    save: 'Spremi',
    aboutText: 'TOK je DJ sufler za YouTube Music playliste — sluša trenutnu pjesmu i predlaže sljedeću po brzini, energiji i tonalitetu, kako bi miks tekao glatko bez prekida.',
    close: 'Zatvori',
